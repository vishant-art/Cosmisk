...
import brain as br            # noqa: E402  (statements + make_plots)
import meta_live as ml        # noqa: E402  (live fetch helpers: get, get_insights_paged, FIELDS)
import meta_transform as mt   # noqa: E402  (L1 transform)
...
def main():
    ...
    if not token:
        print("META_ACCESS_TOKEN not set in repo-root .env")
        sys.exit(1)
