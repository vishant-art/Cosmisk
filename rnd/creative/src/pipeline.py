...
def run(*, data_path: str, run_id: str, strategy="top-roas", n_campaigns=5,
        ...
        direction=None, log=print) -> RunManifest:
...
def plan_story(*, run_id: str, data_path: str, seconds: int = None, creator=None,
               prior=None, graph_prior=None, direction: str | None = None,
               n_shots: int | None = None, log=print
...
def _generate_ads(client, kit, summary, run_dir, manifest, led, *, images,
                  ...
                  graph_prior=None, creator=None, log=print) -> None:
