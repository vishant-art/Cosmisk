...
default suite **400/9** · pg suite **388/10** · `tsc --noEmit` baseline-only (`billing.ts:4` stripe) · `madge --circular` **0 cycles** · ai-layer pytest **618/7** (+2 known cost_ledger baseline fails on shared demo DB; connector_source ignored).
