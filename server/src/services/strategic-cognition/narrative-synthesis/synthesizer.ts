/**
 * Strategic Narrative Synthesis — synthesizer engine.
 *
 * Hosts the NarrativeSynthesizer class plus the factory / convenience
 * functions. Extracted verbatim from narrative-synthesis.ts. No behavior
 * change — structure only.
 */

import { type ConfidenceLevel } from '../recursive-investigator.js';
import { THEME_PATTERNS } from './theme-patterns.js';
import {
  type MarketState,
