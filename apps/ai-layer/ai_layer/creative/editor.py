...
from ai_layer.creative import sfx as sfx_mod  # noqa: E402
...
def add_copy_overlay(video_in, video_out, copy, kit, *, fmt: str = "9:16",
    ...
    """
    from ai_layer.creative import compositor                   # lazy: pulls PIL
    from ai_layer.creative import layout as layout_mod         # lazy
    meta = probe(video_in)
...
def caption_clip(video_in, video_out, script: str, audio_path, *,
    ...
    if transcribe is None:
        from ai_layer.creative import video_providers           # lazy: keeps fal_client out of the import path
