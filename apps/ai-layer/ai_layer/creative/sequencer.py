...
from ai_layer.creative import recovery  # noqa: E402
from ai_layer.creative import verifier_video  # noqa: E402
from ai_layer.creative import video_providers as providers  # noqa: E402
from ai_layer.creative.schemas import BrandKit, RepairLog, Script, Shot, Storyboard, UGCStyle  # noqa: E402
...
def _hero_persona_seed(shot, index: int, cutout_path, creator, run_dir, *, kit, aspect, led,
    ...
    """
    from ai_layer.creative import image_providers                     # lazy: keeps fal_client out
    seeds = Path(run_dir) / "product_seeds"
    seeds.mkdir(parents=True, exist_ok=True)
    item = (product_desc or "the item shown in the reference").strip()
