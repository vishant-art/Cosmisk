...
from ai_layer.creative.schemas import Script, ScriptBeat, Shot, Storyboard  # noqa: E402
...
def test_our_own_micro_shake_does_not_rescue_a_frozen_shot(tmp_path):
    ...
    from ai_layer.creative.schemas import EditPlan, UGCStyle
...
def test_a_punch_in_on_a_still_is_still_a_still(tmp_path):
    from ai_layer.creative import editor
    from ai_layer.creative.schemas import EditPlan
