...
The repository is faked (an in-memory list), so no database is required.
"""
from __future__ import annotations

import pytest

from ai_layer.creative import config, outcomes, story_brain
from ai_layer.creative.schemas import CreativePrior


# --- a fake creative_variants table --------------------------------------------
...
def test_the_prior_reaches_every_generation_prompt():
    ...
    from ai_layer.creative.schemas import AxisFinding
