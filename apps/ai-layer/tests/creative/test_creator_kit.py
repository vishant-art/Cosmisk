...
from ai_layer.creative import (config, image_providers, pipeline, prompt_builder,
                               sequencer, story_brain, video_providers)
from ai_layer.creative.schemas import (BrandKit, CreatorKit, Script, ScriptBeat, Shot,
                                       Storyboard)
...
def test_the_script_is_written_in_the_creators_voice(maya, brand_kit, fake_client):
    ...
    import ai_layer.creative.brain as brain_mod
