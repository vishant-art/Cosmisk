...
- **Wiring the TS S3 client to R2 later** (if apps/api ever needs to upload/presign on its own — e.g. audio #48): triggers, gotchas (`forcePathStyle`, `WHEN_REQUIRED`), and the reactivation blueprint live in [`dev_reports/2026-07-19-ts-r2-client-future-work.md`](../../../dev_reports/2026-07-19-ts-r2-client-future-work.md). Not on the demo path.
